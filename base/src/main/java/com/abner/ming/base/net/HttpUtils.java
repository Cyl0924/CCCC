...
public class HttpUtils {
    ...
    public HttpUtils setHead(Map<String, Object> headMap) {
    ...
    //get请求
    public HttpUtils get(String url, Map<String, Object> map) {
        this.url = url;
        if (map == null) {
            map = new HashMap<>();
        }
    ...
    //get无请求头
    public HttpUtils getNoHeader(String url, Map<String, Object> map){
        this.url = url;
        HttpService service = getHttpService();
        Observable<ResponseBody> ob = service.getNoHeader(url,map);
        return this;
    }

    //post请求
    public HttpUtils post(String url, Map<String, Object> map) {
        this.url = url;
        HttpService service = getHttpService();
    ...
    //post无请求头
    public HttpUtils postNoHeader(String url, Map<String, Object> map){
        this.url = url;
        HttpService service = getHttpService();
        Observable<ResponseBody> ob = service.postNoHeader(url , map);
        send(ob);
        return this;
    }

    //put请求
    public HttpUtils put(String url, Map<String, Object> map) {
        this.url = url;
        HttpService service = getHttpService();
    ...
    //delete请求
    public HttpUtils delete(String url, Map<String, Object> map) {
        this.url = url;
        HttpService service = getHttpService();
