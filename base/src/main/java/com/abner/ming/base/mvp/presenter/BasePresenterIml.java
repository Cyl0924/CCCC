...
public class BasePresenterIml implements BasePresenter, BaseModel.CallBackListener {
    ...
    @Override
    public void get(int type, String url, Map<String, Object> map) {
        baseModel.get(type, url, map, this);
    }

    @Override
    public void getNoHeader(int type, String url, Map<String, Object> map) {
        baseModel.getNoHeader(type,url,map,this);
    }

    @Override
    public void post(int type, String url, Map<String, Object> map) {
        baseModel.post(type, url, map, this);
    }

    @Override
    public void postNoHeader(int type, String url, Map<String, Object> map) {
        baseModel.postNoHeader(type,url,map,this);
    }

    @Override
    public void put(int type, String url, Map<String, Object> map) {
        baseModel.put(type, url, map, this);
    }

    @Override
    public void delete(int type, String url, Map<String, Object> map) {
