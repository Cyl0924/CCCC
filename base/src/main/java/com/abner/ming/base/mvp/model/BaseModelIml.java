...
public class BaseModelIml implements BaseModel {
    ...
    //get请求
    @Override
    public void get(int type, String url, Map<String, Object> map, CallBackListener listener) {
        doHttp(0, type, url, map, listener);
    }

    //post请求
    @Override
    public void post(int type, String url, Map<String, Object> map, CallBackListener listener) {
        doHttp(1, type, url, map, listener);
    }

    //put请求
    @Override
    public void put(int type, String url, Map<String, Object> map, CallBackListener listener) {
        doHttp(2, type, url, map, listener);
    }

    //delete请求
    @Override
    public void delete(int type, String url, Map<String, Object> map, CallBackListener listener) {
        doHttp(3, type, url, map, listener);
    }

    @Override
    public void getNoHeader(int type, String url, Map<String, Object> map, CallBackListener listener) {
        doHttp(4,type,url,map,listener);
    }

    @Override
    public void postNoHeader(int type, String url, Map<String, Object> map, CallBackListener listener) {
        doHttp(5,type,url,map,listener);
    }

    //执行网络请求
    private void doHttp(int state, final int type, String url, Map<String, Object> map, final CallBackListener listener) {
        ...
        if (state == 0) {//get
            ...
            httpUtils.getNoHeader(url,map);
        }else if(state == 5){
            httpUtils.postNoHeader(url,map);
        }
    ...
    public void setHead(Map<String, Object> headMap) {
